...
class FrontControllerTest extends WebTestCase
{
    ...
    private string $path = '/front/';
    private EntityManagerInterface $manager;

    protected function setUp(): void
    {
        $this->client = static::createClient();
        $this->repository = static::getContainer()->get('doctrine')->getRepository(Front::class);
    ...
    public function testIndex(): void
    {
        ...
        self::assertPageTitleContains('Front index');
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'front[nombre]' => 'Testing',
            'front[logo]' => 'Testing',
            'front[nivel]' => 'Testing',
        ]);

        self::assertResponseRedirects('/front/');
    ...
    public function testShow(): void
    {
        ...
        self::assertResponseStatusCodeSame(200);
        self::assertPageTitleContains('Front');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'front[nombre]' => 'Something New',
            'front[logo]' => 'Something New',
            'front[nivel]' => 'Something New',
        ]);
